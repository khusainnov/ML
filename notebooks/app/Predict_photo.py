        ...
        if filename.endswith("png") or filename.endswith("jpg"):
            ...
            for detection in detections:
                ...
                if confidence > 0.9:
                    ...
                    for images in os.listdir(f'/Users/rustamkhusainov/MO/data/actors_usa//{index_usa}'):
                        image_usa = cv2.imread(os.path.join(f'/Users/rustamkhusainov/MO/data/actors_usa/{index_usa}', images))
                        break
                    for images in os.listdir(f'/Users/rustamkhusainov/MO/data/actors_ussr_russia/{index_ussr}'):
                        image_ussr = cv2.imread(os.path.join(f'/Users/rustamkhusainov/MO/data/actors_ussr_russia/{index_ussr}', images))
                        break
